import type { ResumeFormData } from '../client/src/types';
...
export const SAMPLE_RESUME_DATA: ResumeFormData = {
  ...
  professionalSummary:
    'Passionate software engineer with hands-on experience building scalable web applications and AI-powered tools. Strong foundation in computer science fundamentals with internship experience at top-tier tech companies. Eager to contribute to impactful products and grow within a collaborative engineering team.',

  certifications: 'AWS Certified Developer – Associate (2023)',
  extracurriculars:
    'ACM Club President (2022–2024), Google Developer Student Club Lead, Hackathon winner at CalHacks 2023',
};
